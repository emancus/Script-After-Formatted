...
:fullscreen
	...
	ECHO 	[32m/ [36mVM[0m		V1) VirtualBox		     V2) VirtualBox	    V3) VirtualBox Installer          [32m/ [36m		------Scarica------	    ----Cancella zip file----				      [32m/  [0m
	...
	ECHO 	[32m/ [0m		E7) Lista pack Atom								      [32m/  [0m											              [32m/  [0m
